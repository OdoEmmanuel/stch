...
interface WalkingCaneIconProps {
  size?: number;
  width?: number;
  height?: number;
  className?: string;
...
const WalkingCaneIcon: React.FC<WalkingCaneIconProps> = ({ 
  size,
  width = size ?? 24, 
  height = size ?? 24, 
  className = '' 
...
export default WalkingCaneIcon;